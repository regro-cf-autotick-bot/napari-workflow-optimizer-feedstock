...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/napari-workflow-optimizer-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15430&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/napari-workflow-optimizer-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `napari-workflow-optimizer` can be installed with:

```
conda install napari-workflow-optimizer
```

It is possible to list all of the versions of `napari-workflow-optimizer` available on your platform with:
